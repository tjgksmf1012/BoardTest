 ...
 * 포인트 주고 빼기
 *
 * 기존 게시판 코드에서 일이 성공한 바로 다음에 한 줄 부르시면 됩니다.
 *
 ...
 * 돌려주는 값은 배열입니다.
 *   awarded  실제로 준 금액
 *   limited  하루 한도가 다 차서 못 줬으면 true
 *
 * 하루 한도는 글을 못 쓰게 막는 게 아닙니다. 한도를 넘겨도 글이랑 댓글은 정상으로
 * 써지고 포인트만 안 붙습니다. 그러니 이 함수 결과를 보고 글 등록을 막지는 말아 주세요.
 */
