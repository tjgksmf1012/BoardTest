<?php
/*
 * 서버 자가진단 — 이식 전에 한 번 돌려 주세요
 *
 *   1) 이 파일 하나를 웹 폴더에 올리고 브라우저로 엽니다
 *   2) 나온 결과를 그대로 보내 주시면 됩니다
 *   3) 확인이 끝나면 반드시 지워 주세요 (서버 정보가 드러납니다)
 *
 * DB 까지 보시려면 아래 네 줄만 채워 주세요. 비워 두면 PHP 만 검사합니다.
 *
 * 이 파일 자체가 PHP 4 문법으로만 쓰여 있어서 아주 옛 서버에서도 돕니다.
 * (클로저·네임스페이스·json_*·DateTime·[] 배열 전부 안 씁니다)
 */
