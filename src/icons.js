...
const PATHS = {
  ...
  list: '<path d="M4 6h.01M4 12h.01M4 18h.01"/><path d="M9 6h11M9 12h11M9 18h11"/>',
  target: '<circle cx="12" cy="12" r="8.5"/><circle cx="12" cy="12" r="4"/><circle cx="12" cy="12" r="1"/>',
  gift: '<rect x="3.5" y="9" width="17" height="11.5" rx="1.5"/><path d="M2.5 9h19"/><path d="M12 9v11.5"/><path d="M12 9S9.5 9 8.3 7.8A2 2 0 0 1 11.1 5C12 5.9 12 9 12 9z"/><path d="M12 9s2.5 0 3.7-1.2A2 2 0 0 0 12.9 5C12 5.9 12 9 12 9z"/>',
