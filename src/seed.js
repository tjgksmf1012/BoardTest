...
function seed() {
  ...
  // 한 페이지에 10개씩 보여주므로 넉넉히 채워 여러 쪽이 되게 한다.
  ...
  const older = [
    ...
    [gold, '정보', '주휴수당 계산하는 법 정리', '주 15시간 이상 일하고 결근 없으면 받을 수 있어요.\n\n주휴수당 = 1일 소정근로시간 × 시급\n\n헷갈리면 고용노동부 계산기 써보세요!', 402, 27],
    ...
    [luno, '이벤트', '신규 오픈 기념 인사드려요', '이번에 새로 문 연 곳입니다.\n앞으로 잘 부탁드려요!', 96, 24],
    [cherry, '정보', '알바 구할 때 조심해야 할 공고', '- 업무 내용이 지나치게 두루뭉술한 곳\n- 면접 전에 개인정보부터 요구하는 곳\n- 시급이 시세보다 지나치게 높은 곳\n\n한 번씩 확인하고 가세요.', 517, 23],
    ...
    [street, '정보', '지하철 막차 시간 정리해뒀어요', '야간 끝나고 막차 놓친 적이 많아서 정리했어요.\n노선마다 다르니 미리 확인해두시면 좋아요!', 233, 20],
    ...
    [gold, '정보', '알바 관련 상담받을 수 있는 곳', '고용노동부 고객상담센터(1350)에서 무료로 상담해줘요.\n전화가 어려우면 홈페이지로도 접수됩니다.', 386, 10],
    ...
    [cherry, '정보', '알바 지원할 때 쓰는 자기소개 예시', '길게 쓸 필요 없어요.\n\n- 지원 동기 한 줄\n- 가능한 요일과 시간\n- 관련 경험 한 줄\n\n이 정도면 충분하더라구요.', 529, 6],
  ];
